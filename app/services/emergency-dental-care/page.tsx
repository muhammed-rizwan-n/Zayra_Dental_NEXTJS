  ...
  const emergencyTypes = [
    {
      ...
      description: "Intense, throbbing pain that interferes with daily activities",
      urgency: "Immediate",
    ...
    },
    {
      ...
      treatment: "Tooth reimplantation if possible, or immediate replacement options"
    },
    {
  ...
  const whyChooseUs = [
    {
      ...
      description: "Call anytime for immediate guidance and appointment scheduling",
      icon: <Phone size={32} />
    },
    {
          ...
          <div className="row align-items-center">
            <div className="col-lg-6" data-aos="fade-right">
              <div className="d-flex align-items-center gap-2 mb-3">
                <Link href="/services" className="text-decoration-none text-accent">Services</Link>
              ...
              <div className="row g-4">
                <div className="col-4">
                  <div className="text-center">
                    <div className="heading-tertiary text-accent mb-1">24/7</div>
                ...
                <div className="col-4">
                  <div className="text-center">
                    <div className="heading-tertiary text-accent mb-1">100%</div>
                ...
                <div className="card-modern h-100">
                  <div className="d-flex align-items-start gap-3">
                    ...
                    <div className="flex-grow-1">
                      ...
                      <p className="text-subtle mb-2">{emergency.description}</p>
                      <div className="small">
                        <strong>Treatment: </strong>
                        <span className="text-subtle">{emergency.treatment}</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {firstAidTips.map((tip, index) => (
              <div key={index} className="col-lg-4" data-aos="fade-up" data-aos-delay={index * 100}>
                <div className="card-modern h-100">
                  ...
                  <h4 className="heading-tertiary mb-3 text-center">{tip.situation}</h4>
                  <ol className="ps-3">
                    {tip.steps.map((step, stepIndex) => (
                      <li key={stepIndex} className="mb-2 small">{step}</li>
                    ))}
                  </ol>
                </div>
              </div>
          ...
          <div className="row g-4">
            <div className="col-lg-3 col-md-6" data-aos="fade-up">
              <div className="text-center">
                ...
                <p className="text-subtle">Call our 24/7 emergency line for immediate guidance and appointment scheduling</p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div className="text-center">
                ...
                <p className="text-subtle">Quick triage to prioritize your case and provide first aid instructions</p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
              <div className="text-center">
                ...
                <p className="text-subtle">Immediate pain relief and comprehensive treatment to resolve the emergency</p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
              <div className="text-center">
                ...
                <p className="text-subtle">Ongoing care plan to ensure complete healing and prevent future emergencies</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row g-4 justify-content-center">
            <div className="col-lg-4" data-aos="fade-up">
              <div className="card-modern text-center h-100">
                ...
                <div className="heading-secondary text-primary-brown mb-3">£120</div>
            ...
            <div className="col-lg-4" data-aos="fade-up" data-aos-delay="100">
              <div className="card-modern text-center h-100">
                ...
                <div className="heading-secondary text-primary-brown mb-3">£180</div>
                <ul className="list-unstyled text-subtle small">
          ...
          <div className="row g-4">
            <div className="col-lg-4" data-aos="fade-up">
              <div className="card-modern text-center h-100">
                <div className="d-flex justify-content-center mb-3">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} size={16} fill="var(--primary-teal)" color="var(--primary-teal)" />
                  ))}
                </div>
                <p className="text-subtle fst-italic mb-3">
                  "Called at 11 PM with excruciating pain. Dr. Reshma met me at the clinic within 30 minutes and saved my tooth."
                </p>
            ...
            <div className="col-lg-4" data-aos="fade-up" data-aos-delay="100">
              <div className="card-modern text-center h-100">
                ...
                <p className="text-subtle fst-italic mb-3">
                  "My son knocked out his front tooth. They saw us immediately and saved the tooth. Amazing emergency care!"
                </p>
            ...
            <div className="col-lg-4" data-aos="fade-up" data-aos-delay="200">
              <div className="card-modern text-center h-100">
                ...
                <p className="text-subtle fst-italic mb-3">
                  "Weekend emergency with severe abscess. They treated me immediately and the infection cleared up quickly."
                </p>
          ...
          <div className="row align-items-center">
            <div className="col-lg-8" data-aos="fade-right">
              <div className="d-flex align-items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="heading-secondary mb-2" style={{ color: 'white' }}>
                    Don't Wait - Get Emergency Care Now!
                  </h2>
                  <p className="lead mb-0" style={{ opacity: 0.9 }}>
                    Dental emergencies require immediate attention. Every minute counts when you're in pain.
                  </p>
                </div>
              </div>
              ...
              <div className="d-flex align-items-center gap-4">
                <div>
                  ...
                  <div className="small" style={{ opacity: 0.9 }}>Emergency Line</div>
                </div>
                <div>
                  <div className="h4 mb-1" style={{ color: 'white' }}>< 30min</div>
                  <div className="small" style={{ opacity: 0.9 }}>Response Time</div>
                </div>
                <div>
                  <div className="h4 mb-1" style={{ color: 'white' }}>Same Day</div>
                  <div className="small" style={{ opacity: 0.9 }}>Treatment</div>
                </div>
              </div>
            </div>
