...
export default function Contact() {
  return (
    <>
      <section
        className="contact-section py-5 bg-transparent"
        style={{ display: "none" }}
      >
          ...
          <div className="row g-4">
              ...
              <form className="shadow p-4 bg-white rounded">
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-control"
                    id="subject"
                    placeholder="Appointment Request, Inquiry, etc."
                  />
                </div>
                <div className="mb-3">
            ...
            <div className="col-md-6">
              <div className="bg-white p-4 shadow rounded h-100">
                ...
                <p>
                  <i className="fas fa-map-marker-alt me-2"></i>123 Smile
                  Street, Dental City, Smileland 456789
                </p>
                <p>
      ...
      <section className="contact-section py-5 text-dark">
        <div className="container">
          <h2 className="text-center my-5 text-white fw-bold">Contact Us</h2>
          <div className="row g-4 align-items-stretch">
            {/* LEFT: Contact Info */}
            <div className="col-md-5">
              <div className="h-100 bg-white p-4 shadow rounded d-flex flex-column justify-content-between">
                <div>
